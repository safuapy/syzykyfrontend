...
const DEFAULT_TEMPLATE = 'Open-source block explorer by SyzykyScan. Search transactions, verify smart contracts, analyze addresses, and track network activity. Complete blockchain data and APIs for the %network_title% network.';
...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/gas-tracker': 'Explore real-time %network_title% gas fees with SyzykyScan\'s advanced gas fee tracker. Get accurate %network_gwei% estimates and track transaction costs live.',
